...
### Pre-trained weights
We released our pre-trained model on pretrained/prior_resnet50.pt, you can download [here](https://github.com/ICCV2023-9929/PRIOR/blob/main/pretrained/prior_resnet50.pt)


### Downstream tasks
This part is under code review and will be released soon.
